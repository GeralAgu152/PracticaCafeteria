...
<head>
    ...
    <title>Menu de la cafeteria</title>
 ...
 <section class="menucafe">
   ...
   <section class="producto1menu">
    ...
    <section class="des1menu">
      ...
      <button type="submit" id="btncappuccino">seleccionar</button>
    </section>
    </section>
   ...
   <section class="producto2menu"> 
      ...
      <section class="des2menu">
       ...
       <button type="submit" id="btntollo_canela">seleccionar</button>
      </section>
   </section>
   ...
   <section class="producto3menu"> 
    ...
    <section class="des3menu">
     ...
     <button type="submit" id="btnte_helado">seleccionar</button>
    </section>
 </section>
  </section>
